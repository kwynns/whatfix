...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.start=");
    idx += (13 + "start".length);  // 
  }
  if (idx >= 0) {
